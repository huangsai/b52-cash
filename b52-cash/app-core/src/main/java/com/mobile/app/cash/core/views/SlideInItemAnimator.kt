...
import com.mobile.guava.android.ui.view.listenForAllSpringsEnd
import com.mobile.guava.android.ui.view.spring

/**
 * A [RecyclerView.ItemAnimator] that fades & slides newly added items in from a given direction.
 */
